    ...
    return (
        <div className="min-h-screen bg-gray-100 flex items-center justify-center">
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                    ...
                    <div>
                        ...
                        <div className="mt-1 flex items-center space-x-2">
                            ...
                            <button
                                type="button"
                                onClick={handleCopy}
                                className={`py-1 px-3 bg                bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 ${copied ? 'opacity-50' : ''}`}
                            >
                                {copied ? 'Copied!' : 'Copy'}
                            </button>
                        </div>
                ...
                <a
                    href="/"
                    className="mt-6 inline-block w-full py-2 px-4 bg-blue-600 text-white rounded-md hover:bg-blue-700 text-center"
                >
                    Shorten Another URL
                </a>
            </div>
